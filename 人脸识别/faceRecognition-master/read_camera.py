...
class Camera_reader(object):
    ...
    def build_camera(self):
        ...
        face_cascade = cv2.CascadeClassifier(r'C:\Program Files\Python36\Lib\site-packages\opencv\sources\data\haarcascades\Train.xml')
        #读取dataset数据集下的子文件夹名称
        name_list = read_name_list(r'D:\Build')
