...
# def downloadtesk(page_queue,data_queue):
def main():
    # 创建一个任务队列：里面的参数maxsize表示最大的存储量
    page_queue = queue.Queue(200)
...
if __name__ == '__main__':
    ...
    # p1 = Process(target=downloadtesk,args=(page_queue,data_queue))
    # p2 = Process(target=downloadtesk,args=(page_queue,data_queue))
